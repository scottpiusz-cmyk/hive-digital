...
export const metadata: Metadata = {
  ...
  description:
    "Contact Hive Digital for document authentication, apostille, background checks, and visa documentation services. Reach us via WeCom/WeChat, WhatsApp, KakaoTalk, LINE, email, or phone.",
  alternates: {
    canonical: "/contact/",
    languages: {
      en: "/contact/",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-hive-surface border border-hive-border rounded-2xl p-8 text-center">
            ...
            <p className="text-hive-muted text-sm mb-6">
              Scan the QR code to contact Hive on LINE for document-service
              inquiries.
            </p>
            <div className="relative w-44 h-44 mx-auto rounded-xl overflow-hidden border border-hive-border bg-white">
              <Image
                src="/line-qr.jpg"
                alt="Hive LINE contact QR code"
                fill
                sizes="176px"
                className="object-contain"
              />
