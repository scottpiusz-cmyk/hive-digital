...
const services: Service[] = [
  ...
  },
  {
    id: "thailand",
    icon: Globe,
    title: "Thailand Document Authentication",
    image: "/fingerprinting.jpg",
    link: "/thailand-authentication/",
    summary: "Thailand document authentication and legalization services. Thai Embassy legalization for degrees, teaching certificates, FBI checks, and corporate documents.",
    details: [
      "Thai Embassy or Consulate authentication",
      "Pre-authentication by Secretary of State or US Dept of State",
      "Certified Thai translation coordination",
      "Degrees, teaching certificates, corporate docs",
      "End-to-end processing and secure delivery",
      "Guidance for TEFL teachers heading to Thailand",
    ],
  },
  {
    id: "japan",
    icon: Globe,
    title: "Japan Document Apostille",
    image: "/fingerprinting.jpg",
    link: "/japan-apostille/",
    summary: "Japan apostille services for Americans. Hague Apostille for work visas, teaching positions, and corporate documents. Japan member since 1970.",
    details: [
      "Hague Apostille for all Japan-bound documents",
      "State-level and federal apostille processing",
      "Japanese translation coordination",
      "Work visa document packages",
      "Corporate document apostille for business registration",
      "End-to-end processing and secure delivery",
    ],
  },
  {
