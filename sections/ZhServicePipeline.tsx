...
const services = [
  ...
  { id: "business", icon: Building2, title: "中国企业注册", image: null, summary: "从WFOE和合资公司设立到注册后合规，帮助外国企业在中国建立法律实体。", details: ["WFOE注册", "合资公司设立", "营业执照申请", "银行账户开立"] },
  { id: "ancillary", icon: MessageSquare, title: "辅助服务", image: null, summary: "后台运营支持——人力资源、薪资、财务、税务合规和办公选址。", details: ["人力资源与薪资管理", "财务、会计与税务合规", "办公选址与租赁协调"] },
];
