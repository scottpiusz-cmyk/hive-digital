...
const services = [
  { id: "fingerprinting", icon: Fingerprint, title: "指纹采集服务", image: "/fingerprinting.jpg", summary: "覆盖中国、韩国、日本及亚太地区的专业指纹采集解决方案，支持FBI、RCMP/CPIC及国际背景调查要求。具体服务会根据申请人所在地和接收机构要求确认。", details: ["FBI合规指纹采集", "传统墨水指纹", "24小时内数字交付", "安全快递纸质版"], link: "/zh/fingerprinting/" },
  { id: "background-checks", icon: ShieldCheck, title: "联邦与州背景调查", image: "/background-checks.png", summary: "来自美国、加拿大、英国、澳大利亚等国家的犯罪记录检查和身份验证。", details: ["FBI身份历史摘要检查（美国）", "RCMP犯罪记录检查（加拿大）", "ACRO警方证明（英国）", "州级司法部检查"], link: "/zh/services/#background-checks" },
  ...
  { id: "china-visa", icon: Plane, title: "中国签证与工作许可", image: "/china-visa.jpg", summary: "中国Z签证申请和居留许可文件的全流程准备和指导。", details: ["Z签证文件准备与审核", "居留许可申请支持", "文件翻译与认证"], link: "/zh/services/#china-visa" },
  { id: "business-reg", icon: Building2, title: "中国企业注册", summary: "从WFOE和合资公司设立到注册后合规，帮助外国企业在中国建立法律实体。", details: ["WFOE注册", "合资公司设立", "营业执照申请", "银行账户开立"], link: "/zh/services/#business-reg" },
  { id: "ancillary", icon: MessageSquare, title: "辅助服务", summary: "后台运营支持——人力资源、薪资、财务、税务合规和办公选址。", details: ["人力资源与薪资管理", "财务、会计与税务合规", "办公选址与租赁协调"], link: "/zh/services/#ancillary" },
];
                ...
                {service.image && (
                  <div className="relative h-48 w-full">
                    <Image
                      ...
                      alt={service.title}
                      fill
                      className={`object-cover ${service.id === "background-checks" ? "object-[center_25%]" : "object-center"}`}
                    />
                      ...
                      <AnimatePresence>
                        {isOpen && (
                          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.3 }} className="overflow-hidden">
                            ...
                            <Link href={service.link} className="inline-flex items-center gap-1 text-red-400 text-sm mt-4 hover:text-white transition-colors">了解详情 &rarr;</Link>
                          </motion.div>
                        )}
                      </AnimatePresence>
                    </div>
