...
const englishContent = {
  ...
  resources: [
    ...
    { label: "Frequently Asked Questions", href: "/#faq" },
    {
      ...
      href: "/knowledge-centre/fbi-background-check-optimization-2026/",
    },
    { label: "Fingerprinting Guide", href: "/fingerprinting/" },
    { label: "Knowledge Centre Guides and Updates", href: "/knowledge-centre/" },
...
const chineseContent = {
  ...
  resources: [
    ...
    {
      label: "FBI背景调查办理指南",
      href: "/zh/knowledge-centre/fbi-background-check-optimization-2026/",
    },
    { label: "指纹采集指南", href: "/zh/fingerprinting/" },
    { label: "知识中心指南与动态", href: "/zh/knowledge-centre/" },
